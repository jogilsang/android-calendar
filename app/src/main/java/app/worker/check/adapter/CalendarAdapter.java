package app.worker.check.adapter;
...
import app.worker.check.model.CalendarHeader;
import app.worker.check.model.Day;
import app.worker.check.model.EmptyDay;
import app.worker.check.model.ViewModel;
...
public class CalendarAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == HEADER_TYPE) {
            ...
            return new HeaderViewHolder(inflater.inflate(R.layout.item_calendar_header, parent, false));
